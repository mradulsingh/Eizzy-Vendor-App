package com.android.aksiem.eizzy.ui.toolbar.menu;
...
public final class MenuActions implements PopupMenu.OnMenuItemClickListener {
    private static final MenuAction DEFAULT_MENU_ACTION = new DefaultMenuAction();
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        actions.get(itemId, DEFAULT_MENU_ACTION).execute();
    ...
    public static final class Builder {
        ...
        public Builder action(int itemId, MenuAction action) {
            actions.put(itemId, action == null ? DEFAULT_MENU_ACTION : action);
            return this;
        }
