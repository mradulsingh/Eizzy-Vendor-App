...
public class AppServiceTest {
    ...
    @Test
    public void doUserLogin() throws IOException, InterruptedException {
        enqueueResponse("user-yigit.json");
        User yigit = getValue(service.doUserLogin("testUser", "pwd123")).body;

        RecordedRequest request = mockWebServer.takeRequest();
        assertThat(request.getPath(), is("/users/yigit"));

        assertThat(yigit, notNullValue());
        assertThat(yigit.profileUrl, is("https://avatars3.githubusercontent.com/u/89202?v=3"));
    }
